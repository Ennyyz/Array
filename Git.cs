...
namespace Git
{
    class Program
    {
        //Viết chương trình C# để nhập một ma trận, sau đó tính tổng các 
        //phần tử nằm trên đường chéo chính và sắp xếp tăng dần của ma trận và in kết quả trên màn hình.
